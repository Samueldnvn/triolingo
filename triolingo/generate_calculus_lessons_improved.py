#!/usr/bin/env python3
"""
Generate TRIOlingO Calculus Lessons - IMPROVED VERSION
Creates comprehensive calculus lessons with 15-20 questions each,
using seaborn for elegant colored diagrams.
- 70-80% typing questions (most should be type-in answers)
- 70-80% questions with colored diagrams
"""
...
def generate_unit1_lesson1():
    """Lesson: Understanding Limits - 75% typing, 75% diagrams"""
    lesson_id = "1-1"
    questions = []

    # Question 1 - Typing with diagram
    qid = f"calc_u1_l1_q1"
    ...
    # Question 3 - Typing with diagram
    qid = f"calc_u1_l1_q3"
    ...
    # Question 8 - Typing with diagram
    qid = f"calc_u1_l1_q8"
    diagram = generate_limit_diagram(qid, 1, "sin(x)")
    questions.append(create_typing_question(
        qid,
        "What is approximately lim(x→1) sin(x)? (round to 2 decimal places)",
        ["0.84", ".84"], 5, diagram
    ))
    ...
    # Question 11 - Typing with diagram
    qid = f"calc_u1_l1_q11"
    diagram = generate_limit_diagram(qid, 2, "x^2+x")
    questions.append(create_typing_question(
        qid,
        "What is lim(x→2) (x² + x)?",
        ["6"], 5, diagram
...
def generate_unit1_lesson2():
    """Lesson: Calculating Limits - 78% typing, 78% diagrams"""
    lesson_id = "1-2"
    questions = []
    ...
    # Question 3
    qid = f"calc_u1_l2_q3"
    diagram = generate_limit_diagram(qid, 5, "x-3")
    questions.append(create_typing_question(
        qid,
    ...
    # Question 6
    qid = f"calc_u1_l2_q6"
    diagram = generate_limit_diagram(qid, 1, "x^2+2x")
    questions.append(create_typing_question(
        qid,
    ...
    # Question 9
    qid = f"calc_u1_l2_q9"
    diagram = generate_limit_diagram(qid, 6, "x/3")
    questions.append(create_typing_question(
        qid,
    ...
    diagram = generate_limit_diagram(qid, 3, "x^2-2")
    questions.append(create_typing_question(
        qid,
        "What is lim(x→3) (x² - 2)?",
        ["7"], 5, diagram
    ...
    questions.append(create_multiple_choice_question(
        qid,
        "Which method is NOT used to calculate limits?",
        ["Direct substitution", "Factoring", "Integration", "Rationalization"],
        2, 3
    ))
    ...
    diagram = generate_limit_diagram(qid, 1, "3x+2")
    questions.append(create_typing_question(
        qid,
    ...
    diagram = generate_limit_diagram(qid, 0, "4x+1")
    questions.append(create_typing_question(
        qid,
...
def generate_unit2_lesson1():
    """Lesson: Introduction to Derivatives - 78% typing, 67% diagrams"""
    lesson_id = "2-1"
    questions = []
    ...
    # Question 2 - Typing with diagram
    qid = f"calc_u2_l1_q2"
    ...
    # Question 5 - Typing with diagram
    qid = f"calc_u2_l1_q5"
    diagram = generate_derivative_diagram(qid, "x^3", 0)
    questions.append(create_typing_question(
        qid,
        "Geometrically, the derivative is the:",
        ["slope of the tangent line", "tangent line slope"], 5, diagram
    ))

    # Question 6 - Typing with diagram
    qid = f"calc_u2_l1_q6"
    diagram = generate_derivative_diagram(qid, "3x", 1)
    questions.append(create_typing_question(
        qid,
    ...
    # Question 7 - Typing with diagram
    qid = f"calc_u2_l1_q7"
    diagram = generate_derivative_diagram(qid, "cos(x)", 0)
    questions.append(create_typing_question(
        qid,
        "The derivative measures:",
        ["instantaneous rate of change"], 5, diagram
    ))

    # Question 8 - Typing with diagram
    qid = f"calc_u2_l1_q8"
    diagram = generate_derivative_diagram(qid, "x", 1)
    questions.append(create_typing_question(
        qid,
        "What is the derivative of f(x) = x?",
        ["1"], 5, diagram
    ...
    # Question 9 - Typing with diagram
    qid = f"calc_u2_l1_q9"
    diagram = generate_derivative_diagram(qid, "sin(x)", 0)
    questions.append(create_typing_question(
        qid,
        "What is the derivative of sin(x)?",
        ["cos(x)", "cosx"], 5, diagram
    ))

    # Question 10 - Typing with diagram
    qid = f"calc_u2_l1_q10"
    diagram = generate_derivative_diagram(qid, "5", 0)
    questions.append(create_typing_question(
        qid,
    ...
    questions.append(create_typing_question(
        ...
        ["the slope at x=a", "slope"], 5, diagram
    ))

    # Question 12 - Typing with diagram
    qid = f"calc_u2_l1_q12"
    diagram = generate_derivative_diagram(qid, "cos(x)", 1)
    questions.append(create_typing_question(
        qid,
        "What is the derivative of cos(x)?",
        ["-sin(x)", "-sinx", "negative sin of x"], 5, diagram
    ))
    ...
    diagram = generate_derivative_diagram(qid, "4x", 1)
    questions.append(create_typing_question(
        qid,
    ...
    # Question 15 - Typing with diagram
    qid = f"calc_u2_l1_q15"
    diagram = generate_derivative_diagram(qid, "x^4", 1)
    questions.append(create_typing_question(
        qid,
        "The power rule states that d/dx(x^n) =:",
        ["nx^(n-1)", "n x to the power of n-1"], 5, diagram
    ))

    # Question 16 - Typing with diagram
    qid = f"calc_u2_l1_q16"
    diagram = generate_derivative_diagram(qid, "x^4", 2)
    questions.append(create_typing_question(
        qid,
    ...
    # Question 18 - Typing with diagram
    qid = f"calc_u2_l1_q18"
    diagram = generate_derivative_diagram(qid, "2x^2", 1)
    questions.append(create_typing_question(
        qid,
...
def generate_unit2_lesson2():
    """Lesson: Power Rule Practice - 78% typing, 67% diagrams"""
    lesson_id = "2-2"
    questions = []
    ...
    qid = f"calc_u2_l2_q2"
    diagram = generate_derivative_diagram(qid, "x^5", 1)
    questions.append(create_typing_question(
        qid,
        "What is d/dx(x^5)?",
        ["5x^4", "5x⁴"], 5, diagram
    ...
    # Question 3 with diagram
    qid = f"calc_u2_l2_q3"
    diagram = generate_derivative_diagram(qid, "x^7", 1)
    questions.append(create_typing_question(
        qid,
    ...
    # Question 5 with diagram
    qid = f"calc_u2_l2_q5"
    diagram = generate_derivative_diagram(qid, "x^10", 1)
    questions.append(create_typing_question(
        qid,
    ...
    # Question 7 with diagram
    qid = f"calc_u2_l2_q7"
    diagram = generate_derivative_diagram(qid, "x^6", 1)
    questions.append(create_typing_question(
        qid,
    ...
    # Question 10 with diagram
    qid = f"calc_u2_l2_q10"
    diagram = generate_derivative_diagram(qid, "x^8", 1)
    questions.append(create_typing_question(
        qid,
        "What is d/dx(x^8)?",
        ["8x^7", "8x⁷"], 5, diagram
    ...
    # Question 11 with diagram
    qid = f"calc_u2_l2_q11"
    diagram = generate_derivative_diagram(qid, "x^9", 1)
    questions.append(create_typing_question(
        qid,
    ...
    questions.append(create_multiple_choice_question(
        ...
        ["Only linear functions", "Only quadratic functions", "Functions of the form x^n", "Only trigonometric functions"],
        2, 3
    ))

    # Question 14 with diagram
    qid = f"calc_u2_l2_q14"
    diagram = generate_derivative_diagram(qid, "x^2", 4)
    questions.append(create_typing_question(
        qid,
    ...
    # Question 15 with diagram
    qid = f"calc_u2_l2_q15"
    diagram = generate_derivative_diagram(qid, "x^12", 1)
    questions.append(create_typing_question(
        qid,
        "Find the derivative: d/dx(x^12) = ?",
        ["12x^11", "12x¹¹"], 5, diagram
    ))

    # Question 16 with diagram
...
def generate_unit3_lesson1():
    """Lesson: Introduction to Integration - 78% typing, 72% diagrams"""
    lesson_id = "3-1"
    questions = []
    ...
    # Question 2 - Typing with diagram
    qid = f"calc_u3_l1_q2"
    diagram = generate_integral_diagram(qid, "x", (0, 1))
    questions.append(create_typing_question(
        qid,
        "What is ∫x dx?",
        ["x²/2 + C", "x^2/2 + C", "x squared over 2 plus C"], 5, diagram
    ))
    ...
    questions.append(create_typing_question(
        ...
        ["constant of integration", "constant"], 5, diagram
    ))

    # Question 6 - Typing with diagram
    qid = f"calc_u3_l1_q6"
    diagram = generate_integral_diagram(qid, "2x", (0, 2))
    questions.append(create_typing_question(
        qid,
        "What is ∫2x dx?",
        ["x² + C", "x^2 + C"], 5, diagram
    ...
    questions.append(create_typing_question(
        qid,
        "What is ∫sin(x) dx?",
        ["-cos(x) + C", "-cosx + C"], 5, diagram
    ))

    # Question 8 - Typing with diagram
    qid = f"calc_u3_l1_q8"
    diagram = generate_integral_diagram(qid, "cos(x)", (0, 1))
    questions.append(create_typing_question(
        qid,
        "What is ∫cos(x) dx?",
        ["sin(x) + C", "sinx + C"], 5, diagram
    ))
    ...
    questions.append(create_typing_question(
        qid,
        "What is ∫3x dx?",
        ["1.5x² + C", "1.5x^2 + C", "3/2 x squared plus C"], 5, diagram
    ))
    ...
    diagram = generate_integral_diagram(qid, "5", (0, 3))
    questions.append(create_typing_question(
        qid,
        "What is ∫5 dx?",
        ["5x + C"], 5, diagram
    ...
    diagram = generate_integral_diagram(qid, "x^3", (0, 1))
    questions.append(create_typing_question(
        qid,
        "What is ∫x³ dx?",
        ["x⁴/4 + C", "x^4/4 + C"], 5, diagram
    ))
    ...
    diagram = generate_integral_diagram(qid, "4x", (0, 2))
    questions.append(create_typing_question(
        qid,
        "What is ∫4x dx?",
        ["2x² + C", "2x^2 + C"], 5, diagram
    ))
    ...
    diagram = generate_integral_diagram(qid, "e^x", (0, 1))
    questions.append(create_typing_question(
        qid,
        "What is ∫e^x dx?",
        ["e^x + C", "eˣ + C"], 5, diagram
    ))
...
def generate_unit3_lesson2():
    """Lesson: Definite Integrals - 78% typing, 78% diagrams"""
    lesson_id = "3-2"
    questions = []
    ...
    # Question 6
    qid = f"calc_u3_l2_q6"
    diagram = generate_integral_diagram(qid, "3", (0, 3))
    questions.append(create_typing_question(
        qid,
        "What is ∫₀³ 3 dx?",
        ["9"], 5, diagram
    ...
    diagram = generate_integral_diagram(qid, "2x+1", (0, 3))
    questions.append(create_typing_question(
        qid,
        "What is ∫₀³ (2x + 1) dx?",
        ["12"], 5, diagram
    ...
    diagram = generate_integral_diagram(qid, "x", (1, 3))
    questions.append(create_typing_question(
        qid,
        "What is ∫₁³ (x) dx?",
        ["4"], 5, diagram
...
def generate_unit4_lesson1():
    """Lesson: Rates of Change - 78% typing, 72% diagrams"""
    lesson_id = "4-1"
    questions = []
...
def generate_unit4_lesson2():
    """Lesson: Optimization Problems - 78% typing, 78% diagrams"""
    lesson_id = "4-2"
    questions = []
    ...
    # Question 2 - Typing with diagram
    qid = f"calc_u4_l2_q2"
    diagram = generate_optimization_diagram(qid, "Maximize area", 2)
    questions.append(create_typing_question(
        qid,
    ...
    # Question 3 - Typing with diagram
    qid = f"calc_u4_l2_q3"
    diagram = generate_optimization_diagram(qid, "Minimize cost", 2)
    questions.append(create_typing_question(
        qid,
    ...
    # Question 17 - Typing with diagram
...
def generate_all_lessons():
    ...
    print(f"✓ Increased typing questions to ~75% (from 50%)")
    print(f"✓ Increased diagrams to ~75% (from 28%)")
